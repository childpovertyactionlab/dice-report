...
##### Trash Support
::: container
Trash services need support in the area. Esperanza is primarily residential, housing several families in close proximity. The build up and overflow of trash in and around residences poses an extreme health safety risk for the residents, particularly the children. Monthly clean ups by local partners Not My Son, United Peoples Coalition, and activated community members will occur over a six month period.
:::
:::
::: g-col-1
:::
...
<blockquote class="long-quote-container">
    <p>"Sed enim ut sem viverra aliquet eget sit amet tellus."</p>
